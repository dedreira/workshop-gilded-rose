# Gilded Rose - Testing y Refactor

Hola! este repo sirve para crear una dinámica de grupo en la que vamos a ver cómo podemos lidiar con código "legacy", usando como ejemplo la famosa kata ["Gilded Rose"](https://github.com/emilybache/GildedRose-Refactoring-Kata) para C#

pongo aquí el estracto de la descripción de la Kata original, en español:
...
Siéntete libre de realizar cualquier cambio al método `updateQuality` y agregar el código que sea necesario, mientras que todo siga funcionando correctamente. Sin embargo, **no alteres el objeto `Item` ni sus propiedades** ya que pertenecen al goblin que está en ese rincón, que en un ataque de ira te va a liquidar de un golpe porque no cree en la cultura de código compartido.
